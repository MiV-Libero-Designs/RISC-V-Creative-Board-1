#Igloo2 Creative Board - M2GL025-VF256
...
source ./import/components/SHARED_COMPONENTS/CoreAXITOAHBL_CFG3.tcl 
source ./import/components/SHARED_COMPONENTS/COREAXI4INTERCONNECT_0.tcl 
...
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CoreAHBL_0:AHBmmaster0}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CoreAHBL_0:AHBmslave7}



# Add COREAXI4INTERCONNECT_0 instance
sd_instantiate_component -sd_name ${sd_name} -component_name {COREAXI4INTERCONNECT_0} -instance_name {COREAXI4INTERCONNECT_0}



# Add CoreAXITOAHBL_CFG3 instance
sd_instantiate_component -sd_name ${sd_name} -component_name {CoreAXITOAHBL_CFG3} -instance_name {CoreAXITOAHBL_CFG3}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREAXI4INTERCONNECT_0:ARESETN" "CoreAXITOAHBL_CFG3:HRESETN" "CoreAXITOAHBL_CFG3:ARESETN" "CoreAHBL_0:HRESETN" "reset_synchronizer_0:reset_sync" "CoreGPIO_IN:PRESETN" "CoreTimer_0:PRESETn" "CoreUARTapb_0:PRESETN" "CoreGPIO_OUT:PRESETN" "CoreTimer_1:PRESETn" "SRAM_0:HRESETN" "MiV_RV32IMC_CFG2:RESETN" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREAXI4INTERCONNECT_0:ACLK" "CoreAXITOAHBL_CFG3:HCLK" "CoreAXITOAHBL_CFG3:ACLK" "CoreAHBL_0:HCLK" "reset_synchronizer_0:clock" "FCCC_0:GL0" "CoreGPIO_IN:PCLK" "CoreTimer_0:PCLK" "CoreUARTapb_0:PCLK" "CoreGPIO_OUT:PCLK" "CoreTimer_1:PCLK" "SRAM_0:HCLK" "MiV_RV32IMC_CFG2:CLK" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"SRAM_0:AHBSlaveInterface" "CoreAHBL_0:AHBmslave8" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CoreAXITOAHBL_CFG3:AHBMasterIF" "CoreAHBL_0:AHBmmaster1" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREAXI4INTERCONNECT_0:AXI3mslave0" "CoreAXITOAHBL_CFG3:AXISlaveIF" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREAXI4INTERCONNECT_0:AXI4mmaster0" "MiV_RV32IMC_CFG2:AXI4_MSTR" }
