...
sd_connect_pins -sd_name ${sd_name} -pin_names {"reset_synchronizer_0:clock" "FCCC_0:GL0" "MiV_RV32IMC_CFG3:CLK" "CoreGPIO_IN:PCLK" "CoreTimer_0:PCLK" "CoreTimer_1:PCLK" "CoreUARTapb_0:PCLK" "CoreGPIO_OUT:PCLK" }
